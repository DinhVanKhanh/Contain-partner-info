        ...
        foreach ($data as $value) {
            ...
            if ($chkCurrentMonth) {
                $showdata .= '<td class="center padd_10">
                                    ...
                                    <button name="btnFull" id="btnFull' . $value['SeminarId'] . '" onclick=FullSeminarCId($(this).attr("rel")) class="btnFull btnStyle1" rel="' . $value['SeminarId'] . '" value="' . $value['SeminarId'] . '">' .
