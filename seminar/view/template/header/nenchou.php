...
<head>
    ...
    <style type="text/css">
        ...
        TH.smnmida1 { background-color:#d4f2e6; border:1px #888888 solid; padding:8px 0 4px 0; white-space:nowrap; color:#405060; font:bold 92%/150% Meiryo,メイリオ,'ＭＳ Ｐゴシック',sans-serif; }
        TH.smnlist1 { background-color:#e9f9f3; border:1px #888888 solid; padding:5px; white-space:nowrap; color:#405060; font:bold 80%/130% 'ＭＳ Ｐゴシック',sans-serif; }
    ...
    <script type="text/javascript" src="../assets/js/proccess/P_nenchou.js"></script>
</head>
