...
<body>
    ...
    <div align="center">
        <br>
        <FORM method="post" action="complete.php" name="inputform">
            ...
            <tr>
                <td align="center" height="60"><input type="button" value="入力画面へ戻る" style="padding:5px 15px;"
                        onClick="document.inputform.action = 'inputform.php'; document.inputform.submit();">　　<input
                        type="button" value="この内容で申し込む" style="padding:5px 15px;"
                        onClick="sendClientMailC('<?= $SeminarId ?>');"></td>
            </tr>
