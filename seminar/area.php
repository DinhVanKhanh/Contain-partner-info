	...
	$scripts = '<script type="text/javascript" src="assets/js/proccess/P_area.js"></script>' .
            ...
            '<script>
                $(document).ready(function () {
                    ...
                    document.getElementById("arrow-up-down").style.left = $("#main").offset().left + 1060 + "px";
                });
                ...
                <form action="" method="POST">
                    ...
                    <div class="frmSection">
                        ...
                        <div class="show_parent">
                            <table>
                                <tr>
                                    <td style=""><label for="txtStCode">地区コード </label></td>
                                    <td><input type="text" name="txtAcode" id="txtAcode" size="30"
                                            class="img-responsive" maxlength="30" /></td>
                                </tr>
                                <tr>
                                    <td><label for="txtStName">地区名</label></td>
                                    <td><input type="text" name="txtAname" id="txtAname" size="30"
                                            class="img-responsive" maxlength="50" /></td>
                                </tr>
                            </table>
                        </div>
                        <p class="center pb0">
                            <input type="button" name="submit_se" onclick="saveAreas()" value="登録" style="width: 150px; font-size: 15px;" />
