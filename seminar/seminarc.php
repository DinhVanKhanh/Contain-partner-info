<?php
    ...
    $scripts = '<script type="text/javascript" src="assets/js/jquery.form.js"></script>
                <script type="text/javascript" src="assets/js/proccess/P_seminarc.js"></script>
                <script type="text/javascript" src="assets/js/ready/R_seminarc.js"></script>';
    $linkCss = '';
    ...
    <section id="main_content">
        <div class="boxStyle02">
            <div class="clearfix" style="text-align: justify;vertical-align: middle;">
                <p class="scheduleTitle pb0 float_none"> <span>青色申告 直前対策セミナー</span> </p><?php
                    ...
                    <div class="right">
                        <div class="upload_div">
                            <form method="post" name="multiple_upload_form" id="multiple_upload_form"
                                ...
                                <p class="upload btn"><span>PDF一式アップロード</span>
                                    ...
                                    <input type="hidden" name="controller" value="seminarc"/>
                        ...
                        <p class="pb0 float">
                            <input style="display: none;" type="file" id="ipExcel" name="ipExcel"
                                ...
                                onchange="$('#inputExcel').html($(this).val());">
                            <button onclick="document.getElementById('ipExcel').click();" class="btn"
                                style="margin-left:3px;margin-right:2px;background-image: linear-gradient(to bottom, #f9a03a, #fd660d);color:white;">EXCELファイルを選択</button>
                            <button
                                style="padding-left:2px;width:60px; margin-right: 3px;background-image: linear-gradient(to bottom, #f9a03a, #fd660d);color:white;"
                                name="btnImport" id="btnImport" class="btn">取込</button>

                            <button name="btnDeleteAll" id="btnDeleteAll" class="btn"
                                style="padding-left:2px;width:80px; margin-right: 3px;"
                                onclick="checkExistAllSeminarC()">一括削除</button>
                            <button style="padding:5px;width:60px;" name="btnCreate" class="fancy_h620 btn btnAdd"
        ...
        <!-- Upload Multi -->
        <div class="fancyboxConfirm" id="confirmBoxUpload">
            <div id="progress">
        ...
        <section class="section fancyboxSection" id="inline0">
            <h2 class="h2Title"><span>青色申告 直前対策セミナー</span></h2>
            ...
            <div class="frmSection">
                ...
                <div class="show_parent">
                    ...
                    <form action="" accept-charset="utf-8">
                        <table class="tbl_fixed">
                            <tr>
                                <td class="search_col1" style="width: 23%">セミナー名 <span style="color:red">(必須)</span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" id="scDate" placeholder="<?= $today ?>"
                                        style="width:93%;"></td>
                                ...
                                <td style="vertical-align: middle;" class="pb0">
                                    <p id="" style="vertical-align: middle;">
                                        <input type="text" id="year" maxlength='4' value="<?= $year; ?>" style="width:30%"
                                            placeholder="<?= $year; ?>">年
                                        <input type="text" id="month" maxlength='2' value="<?= $month; ?>" style="width:20%"
                                            placeholder="<?= $month; ?>">月
                                        <input type="text" id="day" maxlength='2' value="<?= $day; ?>" style="width:20%"
                                            placeholder="<?= $day; ?>">日
                                    </p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><span id="pdfLabel">PDF</span>
                                    <p id="dlgPdf" style="height: 0px; position: relative; top: 0px;right:-8px;">
                                        <a href="javascript:;" onclick="$('#inputPdf').val(''); $('#deletePdf').val(1);"><img width="26px;"
                                                height="33px;"
                                                src="assets/images/icon_pdf.gif">

                                            <span style="color:red;cursor: pointer;" id="btnPdfDel"
                                                onclick="$('#inputPdf').val('');">削除</span></a>
                                    </p>
                                </td>
                                <td><input type="text" style="width:78%;" id="inputPdf" />
                                    <input type="file" id="ipPdf" name="ipPdf"
                                        onchange="$('#inputPdf').val($(this)[0].files[0].name); $('#deletePdf').val(0);" style="display: none"
                                        accept="application/pdf">
                                    <input type="button" style="position:relative; left:150px; top:-30px; padding:4px;"
                                        name="btnImport" onclick="document.getElementById('ipPdf').click();"
                                        class="btn btnAdd" value="参照"></td>
                            </tr>
                            <tr>
                                <td>備考</td>
                                <td colspan=3><textarea name="note" id="note" class="classy-editor" maxlength="500" rows="3" cols="39" style="width:100%;"></textarea>
                            </tr>
                        </table>
                    </form>
                </div>
                <p class="center">
                    ...
                    <input type="button" name="submit_se" onclick="saveSeminarC();" id="submit_se" value="登録"
